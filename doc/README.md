...
* Building the KACTL                             *
**************************************************
To build the KACTL should be a simple step. Just navigate to the root folder for this project and type 'make umt' (and do your normal Voodoo dance that you do to get an accepted submission). If the build process fails, then it's time to start improving your Voodoo dance, but in the meantime, have a look the debug section below.
...
Finally, you'll need to modify the file content/umt.tex to add the new chapter folder. Notice that if you've followed the instructions above, all you need is to specify the name of the new chapter folder with the 'kactlchapter' command.
...
**************************************************
The edition name and date can be modified from the file content/umt.tex, and are set with the commands \date{2009-04-11} respectively \edition{Edition name}.
